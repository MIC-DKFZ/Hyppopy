...
project.add_hyperparameter(name="axis_02", domain="uniform", data=[-1, 1], dtype="float")
project.add_hyperparameter(name="axis_03", domain="uniform", data=[0, 5], dtype="float")
project.add_hyperparameter(name="axis_04", domain="uniform", data=[1, 10000], dtype="float")
project.add_hyperparameter(name="axis_05", domain="uniform", data=[0, 10], dtype="float")
...
def my_visualization_function(**kwargs):
    ...
    plot_data["axis_05"].append(kwargs['axis_05'])
    ...
    axes[1, 2].clear()
    axes[1, 2].plot(plot_data["loss"], plot_data["axis_05"], ".r")
    axes[1, 2].set_xlabel("loss")
    axes[1, 2].set_ylabel("axis_05")
